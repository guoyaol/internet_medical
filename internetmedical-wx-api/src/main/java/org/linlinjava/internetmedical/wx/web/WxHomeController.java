...
public class WxHomeController {
    ...
    @Autowired
    private InternetmedicalAdService adService;
    ...
    public Object cache(@NotNull String key) {
        if (!key.equals("internetmedical_cache")) {
    ...
    private List<Map> getCategoryList() {
        ...
        List<InternetmedicalCategory> catL1List = categoryService.queryL1WithoutRecommend(0, SystemConfig.getCatlogListLimit());
        for (InternetmedicalCategory catL1 : catL1List) {
            List<InternetmedicalCategory> catL2List = categoryService.queryByPid(catL1.getId());
            List<Integer> l2List = new ArrayList<>();
            for (InternetmedicalCategory catL2 : catL2List) {
                l2List.add(catL2.getId());
            }

            List<InternetmedicalGoods> categoryGoods;
            if (l2List.size() == 0) {
