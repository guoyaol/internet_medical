...
import org.linlinjava.internetmedical.db.service.InternetmedicalCommentService;
...
import org.linlinjava.internetmedical.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(InternetmedicalComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody InternetmedicalComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<InternetmedicalComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (InternetmedicalComment comment : commentList) {
