...
import org.linlinjava.internetmedical.db.service.CouponAssignService;
...
import org.linlinjava.internetmedical.wx.dto.UserToken;
import org.linlinjava.internetmedical.wx.dto.WxLoginInfo;
import org.linlinjava.internetmedical.wx.service.CaptchaCodeManager;
import org.linlinjava.internetmedical.wx.service.UserTokenManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<InternetmedicalUser> userList = userService.queryByUsername(username);
        InternetmedicalUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        InternetmedicalUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new InternetmedicalUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                InternetmedicalUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<InternetmedicalUser> userList = userService.queryByMobile(mobile);
        InternetmedicalUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
