...
public class WxAftersaleController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<InternetmedicalAftersale> aftersaleList = aftersaleService.queryList(userId, status, page, limit, sort, order);

        List<Map<String, Object>> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (InternetmedicalAftersale aftersale : aftersaleList) {
            List<InternetmedicalOrderGoods> orderGoodsList = orderGoodsService.queryByOid(aftersale.getOrderId());
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer orderId) {
        ...
        InternetmedicalAftersale aftersale = aftersaleService.findByOrderId(userId, orderId);
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody InternetmedicalAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
     ...
     */
    @PostMapping("cancel")
    public Object cancel(@LoginUser Integer userId, @RequestBody InternetmedicalAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        ...
        InternetmedicalAftersale aftersaleOne = aftersaleService.findById(userId, id);
    ...
    private Object validate(InternetmedicalAftersale aftersale) {
