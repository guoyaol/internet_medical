...
export const asyncRoutes = [
...

  {
    ...
    children: [
      ...
      {
        path: 'qualification',
        component: () => import('@/views/doctor/qualification'),
        name: 'qualification',
        meta: {
          title: '医生资质',
          noCache: true
...

  {
    ...
    children: [
      {
        path: 'record',
        component: () => import('@/views/inquiry/record'),
        name: 'record',
        meta: {
          title: '问诊记录',
          noCache: true
      ...
      {
        path: 'medication',
        component: () => import('@/views/inquiry/medication'),
        name: 'medication',
        meta: {
          title: '药方记录',
          noCache: true
      ...
      {
        path: 'complaint',
        component: () => import('@/views/inquiry/complaint'),
        name: 'complaint',
        meta: {
          title: '投诉管理',
          noCache: true
