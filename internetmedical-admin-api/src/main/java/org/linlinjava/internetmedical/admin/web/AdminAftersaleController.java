...
import org.linlinjava.internetmedical.admin.service.LogHelper;
...
import static org.linlinjava.internetmedical.admin.util.AdminResponseCode.ORDER_REFUND_FAILED;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private InternetmedicalGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<InternetmedicalAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody InternetmedicalAftersale aftersale) {
        Integer id = aftersale.getId();
        InternetmedicalAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            InternetmedicalAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody InternetmedicalAftersale aftersale) {
        Integer id = aftersale.getId();
        InternetmedicalAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody InternetmedicalAftersale aftersale) {
        Integer id = aftersale.getId();
        InternetmedicalAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        InternetmedicalOrder order = orderService.findById(orderId);
