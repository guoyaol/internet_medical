...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<InternetmedicalIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(InternetmedicalIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody InternetmedicalIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        InternetmedicalIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody InternetmedicalIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody InternetmedicalIssue issue) {
