...
import org.linlinjava.internetmedical.db.service.InternetmedicalAdService;
...
public class AdminAdController {
    ...
    public Object list(String name, String content,
        ...
        List<InternetmedicalAd> adList = adService.querySelective(name, content, page, limit, sort, order);
        return ResponseUtil.okList(adList);
    }

    private Object validate(InternetmedicalAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody InternetmedicalAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        InternetmedicalAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody InternetmedicalAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody InternetmedicalAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
