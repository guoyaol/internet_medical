...
public class AdminTaskStartupRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        List<InternetmedicalGrouponRules> grouponRulesList = rulesService.queryByStatus(GrouponConstant.RULE_STATUS_ON);
        for(InternetmedicalGrouponRules grouponRules : grouponRulesList){
