...
import org.linlinjava.litemall.db.service.LitemallDoctorsService;
...
public class AdminDoctorController {
    ...
    @Autowired
    private LitemallDoctorsService DoctorService;
    ...
    public Object list(String doctorname, String mobile,
        ...
        List<LitemallDoctors> doctorList = DoctorService.querySelective(doctorname, mobile, page, limit, sort, order);
    ...
    public Object doctorDetail(@NotNull Integer id) {
    	LitemallDoctors doctor=DoctorService.findById(id);
        return ResponseUtil.ok(doctor);
    }
    @RequiresPermissions("admin:doctor:list")
    @RequiresPermissionsDesc(menu = {"用户管理", "医生管理"}, button = "编辑")
    @PostMapping("/update")
    public Object doctorUpdate(@RequestBody LitemallDoctors doctor) {
