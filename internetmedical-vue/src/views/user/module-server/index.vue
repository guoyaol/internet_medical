<template>
  <div>
    ...
    <van-popup v-model="showKefu">
      <van-cell-group>
        <van-cell title="项目名称" value="internetmedical" />
        <van-cell title="项目地址" value="Github"  url="https://github.com/linlinjava/internetmedical"/>
        <van-cell title="项目地址" value="Gitee"  url="https://gitee.com/linlinjava/internetmedical"/>
